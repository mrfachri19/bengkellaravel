...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container">
            <form action="/updatemekanik/{{ $data->id }}" method="POST" enctype="multipart/form-data" class="card p-3">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Kode Karyawan"
                        name="kodekaryawan" value="{{ $data->kodekaryawan }}">
                </div>
