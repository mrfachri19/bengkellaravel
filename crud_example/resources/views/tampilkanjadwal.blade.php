...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container">
            <form action="/updatejadwal/{{ $data->id }}" method="POST" enctype="multipart/form-data" class="card p-3">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="time" class="form-control" id="exampleFormControlInput1" placeholder="Kode"
